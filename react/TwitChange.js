...
class TwitChange extends Component {
  constructor(props) {
    super(props);
    this.state = {
      twits: [],
  ...
  render() {
    return (
      <div className="form-wrapper">
        ...
        <TwitList entries={this.state.twits} filtered={this.state.filtered} delete={this.deleteFromList}>{this.state.twits}</TwitList>
      </div>
    );
  }
}

export default TwitChange;
