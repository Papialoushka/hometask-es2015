...
/******/ 	var hotCurrentHash = "982278364fdabe0f8ec0"; // eslint-disable-line no-unused-vars
...
// to indexed object, toObject with fallback for non-array-like ES3 strings
var IObject = __webpack_require__(411);
...
// module
exports.push([module.i, ".news-resource {\r\n  display: -ms-flexbox;\r\n  display: flex;\r\n  -ms-flex-direction: column;\r\n  flex-direction: column;\r\n  width: 47%;\r\n  padding: 1em;\r\n  background: #efefef;\r\n  border-radius: 5px;\r\n}\r\n\r\n.resources {\r\n  -ms-flex-pack: justify;\r\n  justify-content: space-between;\r\n  -ms-flex-wrap: wrap;\r\n  flex-wrap: wrap;\r\n  margin: 0 auto;\r\n  width: 80%;\r\n}\r\n\r\n.news-resource,\r\n.news-resource h2 {\r\n  margin-bottom: 20px;\r\n}\r\n\r\n.news-resource h2 img {\r\n  vertical-align: middle;\r\n  margin-right: 50px;\r\n  width: 20%;\r\n}\r\n\r\n/* Media Queries */\r\n@media screen and (max-width: 640px) {\r\n  .resources,\r\n  .news-resource,\r\n  .news-resource h2 img {\r\n    width: 100%;\r\n  }\r\n\r\n  .news-resource {\r\n    padding: 0.5em;\r\n  }\r\n\r\n  .news-resource,\r\n  .news-resource h2 {\r\n    margin-bottom: 10px;\r\n  }\r\n\r\n  .news-resource h2 img {\r\n    margin-right: 0;\r\n  }\r\n}\r\n\r\n@media screen and (min-width: 641px) and (max-width: 1024px) {\r\n  .resources {\r\n    width: 100%;\r\n  }\r\n\r\n  .news-resource {\r\n    width: 47%;\r\n  }\r\n\r\n  .news-resource h2 img {\r\n    float: left;\r\n  }\r\n}", ""]);
...
var _createEntity = __webpack_require__(184);

var _createEntity2 = _interopRequireDefault(_createEntity);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var ResourcePage = function (_Entity) {
  (0, _inherits3.default)(ResourcePage, _Entity);

  function ResourcePage(obj) {
    (0, _classCallCheck3.default)(this, ResourcePage);

    var _this = (0, _possibleConstructorReturn3.default)(this, (ResourcePage.__proto__ || (0, _getPrototypeOf2.default)(ResourcePage)).call(this, obj));

    _this.title = obj.title;
    _this.id = obj.source.id;
    _this.logo = obj.urlToImage;
    _this.date = new Date(obj.publishedAt).toLocaleDateString();
    _this.attrTitle = 'Go to an external resource to read';
    _this.header = obj.source.name;
    return _this;
  }

  return ResourcePage;
}(_createEntity2.default);
...
var Entity = function () {
  ...
  (0, _createClass3.default)(Entity, [{
    key: 'createListItem',
    value: function createListItem(listItemName, listId) {
...
var buttonReturn = new Button().create();

exports.default = buttonReturn;
...
$export($export.P + $export.F * (__webpack_require__(58) != Object || !__webpack_require__(23)(arrayJoin)), 'Array', {
...
var _renderArticles = __webpack_require__(402);

var _renderArticles2 = _interopRequireDefault(_renderArticles);

var _renderResources = __webpack_require__(440);
...
(function () {
  var resourcesList = document.getElementById('newsResources');
  var buttonWrapper = document.getElementById('buttonWrapper');

  (0, _renderResources2.default)();
  buttonWrapper.appendChild(_button2.default);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(399), __webpack_require__(85)))
...
exports.default = renderArticles;

var _articles = __webpack_require__(168);

var _articles2 = _interopRequireDefault(_articles);

var _plainText = __webpack_require__(435);
...
var _mediator = __webpack_require__(437);

var _mediator2 = _interopRequireDefault(_mediator);

var _observer = __webpack_require__(438);

var _observer2 = _interopRequireDefault(_observer);

var _scroll = __webpack_require__(439);
...
function renderArticles(id) {
  (function () {
    var apiKey = '59c232ebefc84b5d9c489f4222161cf2';
    var resourceUrl = 'https://newsapi.org/v2/top-headlines?sources=' + id + '&apiKey=' + apiKey;
    var articlesList = document.getElementById('resourceOutput');
    var resourcesList = document.getElementById('newsResources');
    var body = document.body;
    var getResponse = function getResponse(response) {
      return response.json();
    };
    var addHidden = function addHidden(elem) {
      return elem.classList.add('hidden');
    };
    var removeHidden = function removeHidden(elem) {
      return elem.classList.remove('hidden');
    };
    var checkbox = document.getElementById('removeImages');
    var checkboxWrapper = document.getElementById('checkboxWrapper');
    var observe = new _observer2.default();

    fetch(resourceUrl).then(getResponse).then(function (source) {
      source.articles.forEach(function (article) {
        var render = function render() {
          var newArticle = new _articles2.default(article);

          if (checkbox.checked) {
            _mediator2.default.installTo(newArticle);
            newArticle.publish();
          }
        ...
        removeHidden(_button2.default);
        observe.subscribe(_scroll2.default, 'scroll');
        observe.createNewEmitter(body);
        body.emit('scroll');
        observe.unsubscribe(_scroll2.default, 'scroll');
      });
    });
    ...
    var buttonClick = function buttonClick(e) {
      ...
      addHidden(_button2.default);
      articlesList.innerHTML = '';
    };

    _button2.default.addEventListener('click', buttonClick, false);
  })();
}
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(61)(Function.call, __webpack_require__(182).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
        buggy = !(test instanceof Array);
      } catch (e) { buggy = true; }
      return function setPrototypeOf(O, proto) {
...
var PlainTextResourcePage = function (_ResourcePage) {
  (0, _inherits3.default)(PlainTextResourcePage, _ResourcePage);

  function PlainTextResourcePage(obj) {
    (0, _classCallCheck3.default)(this, PlainTextResourcePage);
    return (0, _possibleConstructorReturn3.default)(this, (PlainTextResourcePage.__proto__ || (0, _getPrototypeOf2.default)(PlainTextResourcePage)).call(this, obj));
  }

  (0, _createClass3.default)(PlainTextResourcePage, [{
    key: 'createListItem',
    value: function createListItem(listName, listId) {
      var listItem = document.createElement('li');
      var list = document.getElementById(listId);
  ...
  return PlainTextResourcePage;
}(_articles2.default);

exports.default = PlainTextResourcePage;
...
var ObserversList = function () {
  function ObserversList() {
    (0, _classCallCheck3.default)(this, ObserversList);

    this.observers = {};
  }

  (0, _createClass3.default)(ObserversList, [{
    key: "subscribe",
    value: function subscribe(newObserver, newEvent) {
      this.observers[newEvent] = [];

      if (!this[newEvent]) {
        (0, _defineProperty2.default)(this, newEvent, {
          enumerable: true,
          configurable: true,
          writable: true
        });
    ...
    key: "unsubscribe",
    value: function unsubscribe(newObserver, newEvent) {
      this.observers[newEvent] = this.observers[newEvent].filter(function (currentObserver) {
    ...
    key: "createNewEmitter",
    value: function createNewEmitter(obj) {
      obj.emit = this.emit;
      obj.observers = this.observers;
    }
  }, {
    key: "emit",
    value: function emit(customEvent) {
      this.observers[customEvent].forEach(function (currentObserver) {
        currentObserver();
      });
    }
  }]);
...
function scroll() {
  var header = document.getElementById('mainContent');
...
exports.default = renderResources;

var _newsResourcesLink = __webpack_require__(460);

var _newsResourcesLink2 = _interopRequireDefault(_newsResourcesLink);
...
function renderResources() {
  ...
  var apiKey = '59c232ebefc84b5d9c489f4222161cf2';
  var apiUrl = 'https://newsapi.org/v2/sources?apiKey=' + apiKey;
  var getResponse = function getResponse(response) {
    return response.json();
  };
  var getResources = function getResources(resources) {
    resources.sources.forEach(function (source) {
      var newResourceItem = new _newsResourcesLink2.default(source);
...
if (!USE_NATIVE) {
  ...
  Internal.prototype = __webpack_require__(455)($Promise.prototype, {
    // 25.4.5.3 Promise.prototype.then(onFulfilled, onRejected)
    then: function then(onFulfilled, onRejected) {
      var reaction = newPromiseCapability(speciesConstructor(this, $Promise));
      reaction.ok = typeof onFulfilled == 'function' ? onFulfilled : true;
...
var ctx = __webpack_require__(61);
var call = __webpack_require__(450);
var isArrayIter = __webpack_require__(451);
var anObject = __webpack_require__(33);
var toLength = __webpack_require__(177);
var getIterFn = __webpack_require__(452);
var BREAK = {};
var RETURN = {};
var exports = module.exports = function (iterable, entries, fn, that, ITERATOR) {
  var iterFn = ITERATOR ? function () { return iterable; } : getIterFn(iterable);
...
var NewsResource = function (_Entity) {
  (0, _inherits3.default)(NewsResource, _Entity);

  function NewsResource(obj) {
    (0, _classCallCheck3.default)(this, NewsResource);

    var _this = (0, _possibleConstructorReturn3.default)(this, (NewsResource.__proto__ || (0, _getPrototypeOf2.default)(NewsResource)).call(this, obj));

    _this.logo = 'https://icons.better-idea.org/icon?url=' + _this.url + '&size=80..120..200';
    _this.attrTitle = 'Click to read';
    return _this;
  }
...
module.exports = {"after":{"78":"wonderful","life":"extremely"}}
