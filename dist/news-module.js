...
var NewsResource = function () {
  ...
  (0, _createClass3.default)(NewsResource, [{
    ...
    value: function createLink() {
      ...
      resource.id = this.id;
      resource.insertAdjacentHTML('afterBegin', '<h2><a href=' + this.url + ' title="Click to read"><img src=' + this.logo + '>' + this.title + '</a></h2><p>' + this.description + '</p>');
...
var _newsResourcesLink = __webpack_require__(173);

var _newsResourcesLink2 = _interopRequireDefault(_newsResourcesLink);

var _articles = __webpack_require__(420);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(415), __webpack_require__(93)))
...
__webpack_require__(424)('getPrototypeOf', function () {
  return function getPrototypeOf(it) {
    return $getPrototypeOf(toObject(it));
  };
});
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(57)(Function.call, __webpack_require__(179).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
        buggy = !(test instanceof Array);
      } catch (e) { buggy = true; }
      return function setPrototypeOf(O, proto) {
...
var update = __webpack_require__(448)(content, options);
...
exports = module.exports = __webpack_require__(447)(undefined);
// imports
...
var	fixUrls = __webpack_require__(449);
